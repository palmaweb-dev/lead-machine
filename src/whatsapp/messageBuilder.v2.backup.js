...
export class MessageBuilder {
  ...
  async construirInicial(lead, diag) {
    ...
    // Templates hardcoded como fallback
    ...
    // Buscar templates customizados do Supabase (configurados no dashboard)
    ...
    try {
      ...
      if (data?.valor?.templates && data.valor.templates.length > 0) {
        const calendly = process.env.CALENDLY_LINK || '';
      ...
      // Usa templates padrao em caso de erro
    }
